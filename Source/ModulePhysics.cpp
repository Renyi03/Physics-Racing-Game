...
bool ModulePhysics::Start()
{
...

	{
		...
		shape.SetTwoSided(b2Vec2(PIXEL_TO_METERS(0.0f), PIXEL_TO_METERS((MAP_HEIGHT))), b2Vec2(PIXEL_TO_METERS(MAP_WIDTH), PIXEL_TO_METERS(MAP_HEIGHT)));
		floor->CreateFixture(&sd);
		shape.SetTwoSided(b2Vec2(PIXEL_TO_METERS(MAP_WIDTH), PIXEL_TO_METERS((MAP_HEIGHT))), b2Vec2(PIXEL_TO_METERS(MAP_WIDTH), PIXEL_TO_METERS(0.0f)));
		floor->CreateFixture(&sd);
		shape.SetTwoSided(b2Vec2(PIXEL_TO_METERS(0.0f), PIXEL_TO_METERS((0.0f))), b2Vec2(PIXEL_TO_METERS(MAP_WIDTH), PIXEL_TO_METERS(0.0f)));
		floor->CreateFixture(&sd);
		shape.SetTwoSided(b2Vec2(PIXEL_TO_METERS(0.0f), PIXEL_TO_METERS((0.0f))), b2Vec2(PIXEL_TO_METERS(0.0f), PIXEL_TO_METERS(MAP_HEIGHT)));
		floor->CreateFixture(&sd);
	}
